    ...
    <div className="fixed flex h-[1008px] w-[244px] flex-col justify-between border-r-[1px] border-instGrayish pl-3 pr-3 pb-5 dark:border-lightDark dark:bg-black dark:text-white">
      ...
      <div className="flex flex-col gap-9">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div onClick={() => setIsExploreActive(true)}>
            <Icon
              icon={
                <svg
                  aria-label="Explore"
          ...
          <div onClick={() => setIsReelVideoActive(true)}>
            <Icon
              icon={
                <svg
                  aria-label="Reels"
          ...
          <div
            className="relative"
            onClick={() => {
              setIsMessagePopupActive(true);
              setTimeout(() => {
                setIsMessagePopupActive(false);
              }, 3000);
            }}
          >
            <Icon
              ...
              isSearchActive={isSearchActive}
            />{" "}
            {isMessagePopupActive ? (
              <p className="absolute top-0 left-[150px] z-20 w-40 rounded-lg bg-white p-2 text-center shadow-xl">
                {" "}
                The messages functionality was not implemented in this project.{" "}
              </p>
            ) : (
              ""
            )}
          ...
          <div
            className="relative"
            onClick={() => {
              setIsNotificationsPopupActive(true);
              setTimeout(() => {
                setIsNotificationsPopupActive(false);
              }, 3000);
            }}
          >
            <Icon
              ...
              isSearchActive={isSearchActive}
            />
            {isNotificationsPopupActive ? (
              <p className="absolute top-0 left-[150px] z-20 w-40 rounded-lg bg-white p-2 text-center shadow-xl">
                {" "}
                The notifications functionality was not implemented in this
                project.{" "}
              </p>
            ) : (
              ""
            ...
            <Icon
              icon={
                <div className="h-[24px] w-[24px]">
                  {" "}
                  <img src={userInfo.photoURL} className="rounded-xl" />{" "}
                </div>
              }
              iconText={userInfo.displayName}
              isSearchActive={isSearchActive}
            />
          </Link>
        </div>
      ...
      <div
        className={`${
          isMoreMenuActive ? "flex" : "hidden"
        } translate-y-5 flex-col gap-3 dark:text-red-500`}
      >
      ...
      <div
        ...
        } flex cursor-pointer items-center gap-3 p-3 hover:rounded-2xl hover:bg-[#FAFAFA] dark:hover:bg-[#121212]`}
        onClick={() => {
          isMoreMenuActive
            ? setIsMoreMenuActive(false)
            : setIsMoreMenuActive(true);
        }}
      >
        <AiOutlineMenu className="text-2xl" />
        <p
          className={`${isMoreMenuActive ? "font-bold" : ""} ${
            isSearchActive ? "hidden" : ""
          }`}
        >
          {" "}

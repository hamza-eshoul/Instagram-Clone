...
const CreatePost = ({ isAddingPost, setIsAddingPost }) => {
  ...
  return (
    <>
      ...
      {/* Exit Post */}
      <RxCross2
        className="absolute top-4 right-4 z-10 cursor-pointer text-2xl text-white"
        onClick={resetAddPost}
      />
      {/* Add Post */}
      <div className=" absolute top-24 left-[500px] z-10 flex h-[832px] w-[789px] flex-col rounded-xl bg-white">
